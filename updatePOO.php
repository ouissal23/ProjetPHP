...
$row = Researcher::selectResearcherById('Researcher',$connection->conn,$id);
...
$fnameValue = $row["firstname"];
    ...
    if(empty($emailValue) || empty($fnameValue) || empty($lnameValue) ){
        ...
        $researcher = new Researcher($fnameValue,$lnameValue,$emailValue,'');


        Researcher::updateResearcher($researcher,'Researcher',$connection->conn,$_GET['id']);
  ...
  ?>  
            ...
            <div class="row mb-3">
                    ...
                    <div class="col-sm-1 col-sm-3 d-grid">
                        <a class="btn btn-outline-primary" href="readPOO.php">Cancel</a>
                    </div>
            </div>
        </form>
